...
1) Stratified intervention approach
...
2) Adjusted posterior risk by estimating the effect of intervention
...
Under resource-constrained intervention, the stratified intervention approach achieves a slightly better mitigation of AUC bias at all levels of disease prevalence (Fig. 4a) and intervention effectiveness (Fig. 4b) , compared to adjusted posterior risk approach.
...
```{r fig.width = "100%", out.with = "100%", fig.cap="Resource-constrained intervention: AUC bias decrease (a) by prevalence; (b) by intervention effectiveness"}
...
Under point-of-care intervention, the adjusted posterior risk approach achieves a slightly better mitigation of AUC bias at all levels of disease prevalence (Fig. 5a)  and intervention effectiveness (Fig. 5b), compared to stratified intervention approach.
...
```{r fig.width= "300%", out.with = "100%", fig.cap="Point-of-care intervention: AUC bias decrease (a) by prevalence; (b) by intervention effectiveness"}
